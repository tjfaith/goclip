<br>
    ...
    <footer class="about-footer vector-container footer-section">
                        ...
                        <div class="brands">
                            ...
                            <div class="row brands-carousel">
                                <div class="text-center">
                                    <img src="assets/images/benkus.png" alt="">
                                </div>
                                <div class="text-center">
                                    <img src="assets/images/fwdmm.png" alt="">
                                </div>
                                <!-- <div class="text-center">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-first">
                        <!-- <a href="index.html">
                            <img src="assets/images/go.png" class="logo" alt="">
                        </a>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="widget-bottom">
                            <img src="assets/images/vector-09.png" alt="">
                            <div class="widget-content">
                                <h6>Faith Working Avenue, Oguntade Oloja Estate, Behind Sherif Hotel, Odogunyan, Ikorodu, Lagos</h6>
                            </div>
                        </div>
                            <a href="index.htm#">
        ...
        <div class="copyright">
            <p>&copy; Copyright 2021 | <a href="index.htm#">GOCLIP</a></p>
        </div>
    </footer>
    <!-- Javascript Files -->
    ...
    <script src="assets/js/vue_controller.js"></script>
